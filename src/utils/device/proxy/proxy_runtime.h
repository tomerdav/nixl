...
struct alignas(64) nixlProxyChannelState {
    ...
    nixl::mappedHostMem completion_slot_mem_;
    ...
    nixl_status_t
    allocate(nixl::deviceOps &allocator,
             uint32_t depth,
...
private:
    ...
    nixlProxyRuntime(nixlProxyBackendOps backend_ops,
                     const nixlProxyConfig &config,
                     nixl::deviceOps &allocator) noexcept;
    ...
    nixl::deviceMem device_channel_views_mem_;
    nixl::deviceMem device_context_mem_;

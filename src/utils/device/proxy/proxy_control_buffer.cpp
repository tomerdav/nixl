...
nixl_status_t
nixlProxyControlBuffer::allocate(nixl::deviceOps &allocator, size_t count) {
...
nixl_status_t
nixlProxyControlBuffer::allocateMappedHost(nixl::deviceOps &allocator, size_t count) {
...
nixl_status_t
nixlProxyControlBuffer::allocateGdrCopy(nixl::deviceOps &allocator, size_t count) {
#ifdef HAVE_GDRCOPY
